...
<!--[if gt IE 99]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
      ...
      <title>Scrapparel, your choice your apparel</title>
        ...
        <div class="row">
          ...
          <div class="span3 logo-wrapper">
            <a href="?hal=home" class="logo">
              <span class="icon ir">Scrapparel</span>
              <h1>Scrapparel</h1>
            </a>
          </div>
          ...
          <div class="span5 collections">
            ...
            <div>
              <ul class="content rr">
                <li class="current"><a href="">Selamat datang di Toko Online Scrapparel</a></li>
                <li><a href="">Toko online yang selalu update dengan perkembangan mode yang ada</a></li>
                <li><a href="">Ikuti terus perkembangan dari kami untuk berbagai event dan keuntungan khusus</a></li>
              </ul>
            </div>
                ...
                <ul class="connect rr">
                  <li>
                    <a href="#" class="clearfix">
                      ...
                      <span class="phone-no">(022)706 5456</span>
                    </a>
                  </li>
                  <li>
                    <a href="#" class="clearfix">
                      <span class="ir icon mobile">Mobile</span>
                      <span class="phone-no">0878 224 123 70(sms only)</span>
                    </a>
                  </li>
                  <li>
                    <a href="#" class="clearfix">
                      <span class="ir icon mail">Mail</span>
                      <span>dvgn.joshua@gmail.com</span>
                    </a>
                  </li>
                </ul>
              </div>
